...
# 面试 
- 自我介绍 
  - 叫 一直人事软件开发 后端 14~19 c++对接硬件方面  19~24年底  棋牌游戏相关 语言主要为python 目前处于离职
- 承载问题 
  - 排查
    - 初步 redis 进行了业务逻辑的优化(耗时统计 不必要的访问 耗时且非实时性的逻辑放到队列) 后面使用了集群 
    - 人数多起来后 对大厅进程cpu使用异常 进行可扩展的优化 2000~20000 再往上 进行压测 可对进程对桌子数进行调整
    - 
- 有什么要问的 
  - 公司技术栈 岗位负责的具体内容有哪些 
  - 